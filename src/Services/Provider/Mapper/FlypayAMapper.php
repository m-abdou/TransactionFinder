...
class FlypayAMapper implements MapperInterface
{
     ...
     * @Serializer\Type(name="ArrayCollection<App\Services\Provider\Model\FlypayA>")
     */
    ...
    {
        return $this->serializer->deserialize($jsonResponse, FlypayAMapper::class, 'json')->transactions;
    }
